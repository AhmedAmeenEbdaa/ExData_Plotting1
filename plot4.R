readDataset <- function(){
    ...
    plot(strptime(myData$date_time,"%d/%m/%Y  %H:%M:%S"),myData$Voltage,type="l",xlab="datetime",ylab="Voltage")
    ...
    plot(strptime(myData$date_time,"%d/%m/%Y  %H:%M:%S"),myData$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
    dev.off()
}
